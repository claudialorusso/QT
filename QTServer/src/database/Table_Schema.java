...
public class Table_Schema {
	...
	public class Column {
		...
		/**
		 * Costruttore della classe Column.<br>
	 ...
	 * realizzato tramite una lista di {@link Column}s.
	 */
	private List<Column> tableSchema = new ArrayList<Column>();
	
	/**
	 * Costruttore di {@link Table_Schema}.<br>
	 ...
	 * @throws SQLException quando il Server SQL restituisce un avviso o un errore.
	 */
