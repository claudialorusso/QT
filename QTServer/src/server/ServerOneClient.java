...
/**
 * Estende la classe {@link Thread} e
...
class ServerOneClient extends Thread {
	...
	/**
	 * Socket che permette la connessione tra client e server.
	 */
	...
	/**
	 * Oggetto della classe {@link QTMiner} tramite cui calcolare il {@link mining.ClusterSet}
	 */
	private QTMiner qt;
	
	/**
	 * Costruttore di classe.<br>
	 * Inizializza gli attributi di socket, in e out.<br>
	 * Avvia il thread.
	 * @param s Socket
	...
	/**
	 * Riscrive il metodo run della superclasse {@link Thread}
